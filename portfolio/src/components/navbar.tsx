...
const Navbar: React.FC = () => {
  ...
  return (
    <div className="fixed top-0 w-full h-12 bg-white text-slate-900 dark:text-white transition-all duration-300 bg-opacity-10 backdrop-blur-sm border-b-2 border-b-white/20">
